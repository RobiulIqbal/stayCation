...
import ImageFrame from "assets/images/img-frame.jpg";
import IconCities from "assets/images/Icons/icons_cities.svg";
import IconTraveler from "assets/images/Icons/icons_traveler.svg";
import IconTreasure from "assets/images/Icons/icons_treasure.svg";
import Button from "elements/Button";
import numberFormat from "utilitis/format";
    ...
    <section className="container pt-4">
      <div className="row align-item-center">
        ...
        <div className="col-6 pl-5">
          <div style={{ width: 520, width: 410 }}>
            <img src={ImageHero} alt="Room with" className="img-fluid position-absolute" style={{ margin: "-30px 0 0 -30px", zIndex: 1 }} />
            <img src={ImageFrame} alt="Room with" className="img-fluid position-absolute" style={{ margin: "0 -15px -15px 0" }} />
          </div>
        </div>
      </div>
    </section>
